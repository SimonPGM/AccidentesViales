...
ggplot(basemodelo, aes(x = ACCIDENTES_DIARIOS)) +
  ...
  labs(y = "Frecuencia",  x = "Accidentes diarios",
       title = "Distribución del número de accidentes diarios por temporada climática") +
  theme_bw() +
...
ggplot(basemodelo, aes(x = ACCIDENTES_DIARIOS)) +
  ...
  labs(y = "Frecuencia",  x = "Accidentes diarios",
       title = "Distribución de accidentes diarios por días de la semana") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
raw_clean %>% 
  ...
  labs(title = "Distribución de los accidentes por clase",
       x = "Clase de accidente", y = "Cantidad de accidentes") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
ggplot(raw_clean, aes(x = CLASE_ACCIDENTE, fill = CLASE_ACCIDENTE)) +
  ...
  facet_wrap(~ANO) +
  theme_bw() +
  labs(y = "Frecuencia", x = "Clase de accidente", fill = "Clase de accidente",
       title = "Distribución de los accidentes por clase a lo largo de los años") +
  theme(plot.title = element_text(hjust = 0.5), 
...
Con esto, se obtuvo un modelo con capacidad predictiva a nivel diario para el
...
construido para el pronóstico a nivel temporal. 

## Esto puede ser una conclusión
